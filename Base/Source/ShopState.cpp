...
void CShopState::Init()
{
	...
	MeshBuilder::GetInstance()->GenerateQuad("gameShopState", Color(1, 1, 1), 1.f);
	MeshBuilder::GetInstance()->GetMesh("gameShopState")->textureID = LoadTGA("Image//gameShopState.tga");


	float halfWindowWidth = Application::GetInstance().GetWindowWidth() / 2.0f;
	float halfWindowHeight = Application::GetInstance().GetWindowHeight() / 2.0f;
	MenuStateBackground = Create::Sprite2DObject("gameShopState",
